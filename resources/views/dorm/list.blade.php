                        ...
                        <div class="table-responsive text-nowrap">
                            <table class="table">
                                ...
                                <form id="config_form" method="post" action="{{ route('dorm_create') }}">
                                    ...
                                    <tr class="text-center">
                                        <td scope="row"><input form="config_form" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }} text-center" name="name" id="name" value="{{ old('name') }}"></td>
                                        <td scope="row"><input form="config_form" class="form-control{{ $errors->has('supervisor') ? ' is-invalid' : '' }} text-center" name="supervisor" id="supervisor" value="{{ old('supervisor') }}"></td>
                                        <td scope="row"><input form="config_form" class="form-control{{ $errors->has('capacity') ? ' is-invalid' : '' }} text-center" name="capacity" id="capacity" value="{{ old('capacity') }}"></td>
                                        <td scope="row">
                                            <select id="gender" form="config_form" class="form-control{{ $errors->has('gender') ? ' is-invalid' : '' }}" name="gender" required autofocus>
                                ...
                                @foreach($dorms as $dorm)
                                    <form id="config_form{{$loop->iteration}}" method="post" action="{{ route('dorm_edit',['id'=>$dorm->id]) }}">
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td scope="row"><input form="config_form{{$loop->iteration}}" class="form-control text-center" name="gender" id="gender" value="{{$dorm->gender}}"></td>
